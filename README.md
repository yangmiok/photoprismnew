...
* git clone https://github.com/yangmiok/Pictures.git
* git clone https://github.com/yangmiok/assets
...
* git clone https://github.com/yangmiok/photoprismnew.git

* mkdir /root/photoprismnew/assets/photos/originals/
